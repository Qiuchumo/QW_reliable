...
#   用于将单个省电能表数据以组为依据(12行为一组)分为测试集与训练集
...
# =====================================================================================================
def DataSplitOne(Input_X, Input_Y, test_size, GroupSize_Init=7, SubSize=12):
    # 参数定义部分
    ...
    # NumSize_A：随机选中A省需要删除的数据组的序号(12行为一组)
    NumSize_A = []
...
#     X_train, X_test, Y_train, Y_test = DataSplitOne(X, Y, 0.5)
#
