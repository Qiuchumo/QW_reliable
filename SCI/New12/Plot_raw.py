...
# 画出原始图
    ...
    # plt.grid()
    if Savefig == 1:
        plt.savefig('E:\\Code\\Bayescode\\QW_reliable\\SCI\\New12\\New1.png', dpi = 200, bbox_inches='tight')
    plt.show()
    ...
    # plt.grid()
    if Savefig == 1:
        plt.savefig('E:\\Code\\Bayescode\\QW_reliable\\New12\\New2.png', dpi = 200, bbox_inches='tight')
    plt.show()
    ...
    if Savefig == 1:
        plt.savefig('E:\\Code\\Bayescode\\QW_reliable\\New12\\New3.png', dpi = 200, bbox_inches='tight')
    plt.show()
    return 0
